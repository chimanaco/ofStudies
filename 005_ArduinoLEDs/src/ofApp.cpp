...
void ofApp::setup(){
    ...
    gui.add(brightness.set( "brightness", 128, 0, 255 ));
...
void ofApp::updateArduino(){
	...
	if (bSetupArduino) {
        ...
        ard.sendPwm(3, (int)(255 * oscFrequency));   // pwm...
        ard.sendPwm(11, (int)(255 * oscFrequency));   // pwm...
        ard.sendPwm(9, (int)(255 * oscFrequency));   // pwm...
    }
